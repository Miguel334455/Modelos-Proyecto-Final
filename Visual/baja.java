...
public class baja{
    ...
    public baja(Stage popupStage) {
        ...
        Button reserveButton = new Button("Dar de baja");
        ...
        confirmationDialog.setTitle("Confirmar eliminación");
        confirmationDialog.setHeaderText("¿Estás seguro de querer eliminar " + selectedDocument + "?");
